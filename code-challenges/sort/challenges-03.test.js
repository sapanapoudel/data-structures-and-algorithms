...
const sortPeopleBetter = (arr) => {
  // Solution code here...
  arr.sort((a, b) => {
    if (a.firstName === b.firstName && a.lastName === a.lastName) {
      return a.age - b.age;
...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort((a, b) => {
    const aWeekOfTheDay = weekDays.indexOf(a.dayOfWeek);
    const bWeekOfTheDay = weekDays.indexOf(b.dayOfWeek);
    if(aWeekOfTheDay > bWeekOfTheDay) return 1;
    else if(aWeekOfTheDay < aWeekOfTheDay) return -1;
    else return 0;
    // let aDayOfWeek = a.meetings.dayOfWeek;
    // let bDayOfWeek = b.meetings.dayOfWeek;
    // if (aDayOfWeek === bDayOfWeek) return 0;
    // else if(aDayOfWeek < bDayOfWeek) return -1;
    // else if (aDayOfWeek > bDayOfWeek) return 1;
  });
  return arr;
};
